...
const CustomerProfileScreen = () => {
  ...
  const defaultProfileImage =
    'https://th.bing.com/th/id/R.93a2edf3c93cd754c403ba3e14a3c0a0?rik=cuOtgvLbP5FxpA&pid=ImgRaw&r=0';
  ...
  useEffect(() => {
    if (user) {
      ...
      // Fetch and set mobile number from Firestore
      firebase
        .firestore()
        .collection('users')
        .doc(user.uid)
        ...
        .then((doc) => {
          if (doc.exists) {
            ...
            setMobileNumber(userData.mobileNumber || ''); // Set mobile number or an empty string
          }
        })
        .catch((error) => {
  ...
  const uploadProfileImage = async () => {
    try {
      ...
      setProfileImage(image); // Set the selected image
    } catch (error) {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.profileSection}>
        ...
        {isEditing ? (
          <TextInput style={styles.profileInput} value={username} onChangeText={setUsername} />
        ) : (
        ...
        {isEditing ? (
          <TextInput style={styles.profileInput} value={userEmail} onChangeText={setUserEmail} />
        ) : (
        ...
        {isEditing ? (
          <TextInput style={styles.profileInput} value={mobileNumber} onChangeText={setMobileNumber} />
        ) : (
